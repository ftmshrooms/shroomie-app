...
import { Wrapper, MainContent, PreviewImage, InfoContent, Div, Img, MintForm, PriceBox, PreviewImageContent,Discription } from '../../Widget';
      ...
      <Container>
        <MainContent>
          ...
          <InfoContent>
                ...
                title={
                  <>
                    <Typography component="p" className={globalClasses.tooltipText}>
                      🍄 Get 2 Shrooms per mint – 17.5FTM per Shroom 
                    </Typography>
                    <Typography component="p" className={globalClasses.tooltipText}>
                     🍄 125 Shrooms for 0 FTM at the end 
                        (for holders only – first come, first serve)
                    </Typography>
                    <Typography component="p" className={globalClasses.tooltipText}>
                     🍄 125 Shrooms for community treasury
            ...
            <Discription>
                <ul>
				  <li>For each mint you will receive another Shroom for free!</li>
					  <ul>
                        <li>will be sent manually after minting</li>
					  </ul>
                  ...
                  <li>Every FTM.Shrooms holder gets a free FTM.Shroomies NFT airdrop (2nd gen collection)
                      <ul>
                        <li>25% of Shroomies secondary sales royalties will be used for charity</li>
                        <li>50% of Shroomies sales will be redistributed to holders of at least 1 <br/>
